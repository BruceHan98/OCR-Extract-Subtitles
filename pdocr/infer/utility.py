...
def parse_args():
    ...
    parser.add_argument("--image_dir", "-i", type=str, default='./test_subtitle_frames')
    parser.add_argument("--det_algorithm", type=str, default='DB')
    parser.add_argument("--det_model_dir", type=str, default='./pdocr/inference/mobile_v1.1_det_infer')
    parser.add_argument("--det_max_side_len", type=float, default=1920)
    ...
    parser.add_argument("--rec_model_dir", type=str, default='./pdocr/inference/mobile_v1.1_rec_infer')
    parser.add_argument("--rec_image_shape", type=str, default="3, 32, 320")
    parser.add_argument("--rec_char_type", type=str, default='ch')
    parser.add_argument("--rec_batch_num", type=int, default=6)
    parser.add_argument("--max_text_length", type=int, default=25)
    parser.add_argument("--rec_char_dict_path", type=str, default="./pdocr/pyocr/utils/ch_keys_v1.txt")
    ...
    # for extract subtitle
    parser.add_argument("--video_path", "-f", type=str, default='videos/re_cut.flv')
    parser.add_argument("--threshold", "-th", type=float, default=0.4)
    parser.add_argument("--top", "-t", type=int, default=200)
    parser.add_argument("--bottom", "-b", type=int, default=0)
    parser.add_argument("--left", "-l", type=int, default=50)
    parser.add_argument("--right", "-r", type=int, default=50)
    parser.add_argument("--bg_mod", "-c", type=int, default=1)
...
def draw_ocr_box_txt_test(image,
                          result,
                          boxes,
                          txts,
                          scores=None,
    ...
    for idx, (box, txt) in enumerate(zip(boxes, txts)):
        ...
        color = (random.randint(0, 255), random.randint(0, 255),
                 random.randint(0, 255))
        color_cover = (127, 127, 127)
        draw_left.polygon(box, fill=color_cover)
        draw_right.polygon(
            [
    ...
    left.paste(img_left, (0, 0, w, h))

    right = Image.new('RGB', (w, h), (255, 255, 255))
    right.paste(img_right, (0, 0, w, h))
    # img_show = Image.new('RGB', (w * 2, h), (255, 255, 255))
    # img_show.paste(img_left, (0, 0, w, h))
    # img_show.paste(img_right, (w, 0, w * 2, h))
    # return np.array(img_show)
    # print(type(left))  # <class 'PIL.Image.Image'>
    # print(type(np.array(left)))
